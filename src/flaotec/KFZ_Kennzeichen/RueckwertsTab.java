...
public class RueckwertsTab extends Activity {

	int offset = 1;
	boolean PL,D, AT, CH, IT, autochange = false;
	...
	private String getLandByKennung(String kennung){
		if(kennung.compareTo("D")==0){
			return "Deutschland";
		}
		if(kennung.compareTo("AT")==0){
			return "Österreich";
		}
		if(kennung.compareTo("CH")==0){
			return "Schweitz";
		}
		if(kennung.compareTo("IT")==0){
			return "Italien";
		}
		return "";
	}
